...
hold on;
histogram(au,100);
title('Before and After Utility Distribution of 50 Simulations with a 25% Tax (50 Players, 500 Rounds)');
...
histogram(ta,100);
title('Total Amount Distribution of 50 Simulations with a 25% Tax (50 Players, 500 Rounds)');
xlabel('Total Amount');
ylabel('Number of Players');
...
xlabel('Cash');
ylabel('Wheat');
title('Government Tax Distribution of 50 Simulations with a 25% Tax (50 Players, 500 Rounds)');
