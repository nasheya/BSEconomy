...
hold on;
histogram(au,100);
title('Before and After Utility Distribution of 50 Simulations with 25% Tax (10 Players, 500 Rounds)');
...
histogram(ta,100);
title('Total Amount Distribution of 50 Simulations with 25% Tax (10 Players, 500 Rounds)');
xlabel('Total Amount');
ylabel('Number of Players');
...
xlabel('Cash');
ylabel('Wheat');
title('Cash and Wheat Distribution of 50 Simulations with 25% Tax (10 Players, 500 Rounds)');
legend('Before','After');
