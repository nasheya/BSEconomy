...
public class Simulation4{
	...
	public Simulation4(double c, double d, double numBuyers, double numSellers){
		costCreate = c;
		costDissolve = d;

		for(int i=0; i<numBuyers; i++){
			buyers.add(new Agent());
		}

		for(int i=0; i<numSellers; i++){
			sellers.add(new Agent());
		}
	...
	private static ArrayList clone(ArrayList<T> obj){
